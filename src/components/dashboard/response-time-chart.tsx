    ...
    <section className="rounded-xl border border-slate-800 bg-slate-900">
      <header className="flex items-center justify-between border-b border-slate-800 px-5 py-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-slate-500">
            Minutos até responder à primeira mensagem não respondida de um
      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <EmptyState
            icon={Clock}
            title="Ainda não existem respostas registadas"
            hint="Este gráfico é preenchido à medida que responde às mensagens dos clientes."
          />
        ) : (
          ...
          <g key={i}>
            ...
            >
              <title>
                ...
                {b.avgMinutes == null ? 'sem amostras' : `${b.avgMinutes.toFixed(1)} min em média`}
